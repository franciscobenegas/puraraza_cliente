...
const SalidaHome = () => {
  ...
  const columns = [
    ...
    { field: "motivo_salida", headerName: "Motivo Salida", width: 150 },
  ...
  useEffect(() => {
    (async () => {
      const response = await ApiSalidaCtrl.getAll(establesimientoId);
  ...
  const row = map(data, (rowsr) => {
    return {
      ...
      motivo_salida: rowsr.attributes.motivo_salida.data.attributes.nombre,
      motivo_salidaId: rowsr.attributes.motivo_salida.data.id,
      ...
      <Container>
        ...
        >
          <Typography variant="h4" gutterBottom>
            Listado Salida por Clasificacion
          </Typography>
          <Button
            variant="contained"
