...
import { TipoRazaAbm } from "../../../components/ui/tipoRaza/TipoRazaAbm";
...
const TipoRazaHome = () => {
  ...
  useEffect(() => {
    (async () => {
      const response = await tipoRazaCtrl.getAll(establesimientoId);
